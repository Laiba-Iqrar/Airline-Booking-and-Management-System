...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_check = "SELECT * FROM admin WHERE admin_id='$admin_id' AND admin_pwd='$current_password'";
    $result_check = $conn->query($sql_check);

    if ($result_check->num_rows == 1) {
        // Update password
        $sql_update = "UPDATE admin SET admin_pwd='$new_password' WHERE admin_id='$admin_id'";
...
<div class="container">
    ...
    <div class="right-side">
        <div class="change-password-container">
            ...
            <a href="admin_login.php" class="login-link">Back to login</a>
        </div>
    </div>
</div>
</body>
