...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if ($password == $row['admin_pwd']) { // Assuming password is stored as plain text
...
<div class="container">
    ...
    <div class="right-side">
        <div class="login-container">
            ...
            <a href="change_password.php" class="forgot-password-link">Oops forgot your password?Click here</a>
        </div>
    </div>
</div>
</body>
